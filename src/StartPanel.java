...
public class StartPanel extends JPanel implements ActionListener {
  ...
  public StartPanel(CelebrityGame controllerRef) {
    ...
    answerField = new JTextField("Type celebrity here (4 letters min please don't go under 4)");
    clueField = new JTextField("Enter celebrity clue here (10 letters min please don't go under 10)");
